...
import { listsCategoryAPI } from "../../services/category/categoryService";
...
const TransactionForm = () => {
  ...
  const { mutateAsync, isPending, isError:isAddTranErr, error:TranErr, isSuccess }= useMutation({
    ...
    >
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="amount" className="text-gray-700 font-medium">
          <MdCurrencyRupee className="inline mr-2 text-blue-500" />
          Amount
        </label>
        <input
          type="number"
